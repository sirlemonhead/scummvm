 ...
 *
 * $URL: https://scummvm.svn.sourceforge.net/svnroot/scummvm/scummvm/trunk/engines/igor/midi.cpp $
 * $Id: midi.cpp 29672 2007-11-30 19:05:53Z cyx $
 *
 */
...
int AdlibMidiDriver::open() {
	...
	adlibSetupCard();
	_mixer->playStream(Audio::Mixer::kMusicSoundType, &_mixerSoundHandle, this, -1, Audio::Mixer::kMaxChannelVolume, 
		0, DisposeAfterUse::NO, true);
	return 0;
}
